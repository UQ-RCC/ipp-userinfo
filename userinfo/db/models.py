...
class Terastitcher(Base):
    ...
    align_email = Column(Boolean,primary_key=False, unique=False, index=False, nullable=True)
    ...
    visitedSteps = Column(MutableList.as_mutable(PickleType), default=[])
    selected = Column(Boolean, primary_key=False, index=False, default=False)
    qos=Column(String,primary_key=False, unique=False, index=False, nullable=True)
    setup_arrangement_type=Column(Integer,primary_key=False, index=False, nullable=True)
    setup_x=Column(Float,primary_key=False, index=False, nullable=True)
    setup_y=Column(Float,primary_key=False, index=False, nullable=True)
    setup_volformat=Column(String,primary_key=False, unique=False, index=False, nullable=True)
    ### devices
    instances = Column(Integer, primary_key=False, index=False, nullable=True)
    mem = Column(Float, primary_key=False, index=False, nullable=True)
    gpus = Column(Integer, primary_key=False, index=False, nullable=True)
